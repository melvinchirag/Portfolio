/* ============================================================================
 * SocialLinks.tsx — the row of social icon buttons (hero + contact)
 * ----------------------------------------------------------------------------
 * Renders GitHub / LinkedIn / X / Instagram from the shared SOCIALS list. Icons
 * are inlined as SVG (the project has no icon library) using the standard
 * single-path brand marks.
 *
 * Accessibility: every icon carries a visible-to-AT label via `aria-label` +
 * `title`, and the SVG itself is `aria-hidden` so a screen reader announces the
 * platform name once, not the raw path. A social link is never the ONLY way to
 * reach a critical action (the brief's rule) — these supplement the text
 * actions, they don't replace them.
 *
 * A social with an empty href (not yet supplied) renders as a dimmed, inert
 * span with a "link coming soon" title instead of a dead link.
 * ========================================================================= */
